...
__ca__   uint8_t* dst_l0a = (__ca__  uint8_t *)get_imm(0);
  ...
  reg_buf3[0] = (half)1.873343e+00f;
  reg_buf4[0] = (int8_t)2;
  set_vector_mask(0x0, 0xffff);
  for (int32_t j = 0; j < 8; ++j) {
    vadds(((__ubuf__ half *)src_ub + ((j * 16384) + (((int32_t)reg_buf4[0]) * 16))), ((__ubuf__ half *)src_ub + ((j * 16384) + (((int32_t)reg_buf4[0]) * 16))), reg_buf3[0], (int64_t)6917537858093907969);
  }
  set_flag(PIPE_V, PIPE_MTE3, EVENT_ID0);
  wait_flag(PIPE_V, PIPE_MTE3, EVENT_ID0);
  for (int32_t k = 0; k < 4; ++k) {
    copy_ubuf_to_cbuf(((__cbuf__ half *)dst_l1 + ((k * 131072) + (((int32_t)reg_buf4[0]) * 16))), ((__ubuf__ half *)src_ub + (((int32_t)reg_buf4[0]) * 16)), 0, 800, 1, 8, 8);
  }
